...
#include "Ability_AccelerationBoost.generated.h"

/**
 * Applies Agility Up (+35% Speed for turn order) to the target for 3 turns.
...
class JRPGCOMBAT_API UAbility_AccelerationBoost : public UCombatAbility
{
    GENERATED_BODY()
public:
    UAbility_AccelerationBoost()
    {
        DisplayName = FText::FromString("Acceleration Boost");
        bEndsTurn   = true;
