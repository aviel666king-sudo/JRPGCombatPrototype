...
#include "Ability_FencersFlurry.generated.h"

UCLASS(Blueprintable)
class JRPGCOMBAT_API UAbility_FencersFlurry : public UCombatAbility
{
    GENERATED_BODY()
public:
    UAbility_FencersFlurry()
    {
        DisplayName       = FText::FromString(TEXT("Fencer's Flurry"));
        MaxCooldown       = 0;
        bEndsTurn         = true;
